 ...
 */
@Structure.FieldOrder({"aot", "extAOT", "channelMode", "samplingRate", "extSamplingRate", "bitRate", "samplesPerFrame",
        "noChannels", "bitsFrame", "nSubFrames", "BSACnumOfSubFrame", "BSAClayerLength", "flags", "matrixMixdownA",
        "headerPeriod", "stereoConfigIndex", "sbrMode", "sbrSignaling", "sbrPresent", "psPresent"})
